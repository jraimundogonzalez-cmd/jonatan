...
| [20 · Flujo funcional del usuario](./docs/20-flujo-funcional-usuario.md) | Recorrido completo desde la instalación hasta cientos de operaciones y consulta de estadísticas — sin pantallas, solo funcional. Auditado (92/100), madurez 95%, listo para aprobar; recomienda continuar con el Rule Engine (cap. 21) |
