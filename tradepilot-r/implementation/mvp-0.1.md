...
**Bloqueado por**: nada de arquitectura — Operations Engine (este build) ya provee el hecho que faltaba (una Operación puede estar Abierta). Bloqueado solo por priorización: es el siguiente build, no este.
