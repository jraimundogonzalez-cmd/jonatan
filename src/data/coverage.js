...
export const EX_SUBGROUPS = {
  ...
  curl_barra_ez:                       ['bicep_longhead','bicep_shorthead'],
  curl_inclinado_banco_mancuerna:       ['bicep_longhead'],
  curl_arana_scott:                     ['bicep_shorthead'],
  curl_martillo_polea_cuerda:           ['bicep_brachialis','bicep_longhead'],
  curl_maquina_biceps:                  ['bicep_longhead','bicep_shorthead'],
  curl_unilateral_polea_baja:           ['bicep_longhead'],
  curl_bayesian_polea:                  ['bicep_longhead'],
  curl_mancuerna_supinacion_banco:      ['bicep_shorthead','bicep_longhead'],
  curl_predicador_mancuerna_unilateral: ['bicep_shorthead'],
  curl_polea_alta_doble:                ['bicep_shorthead'],
  curl_drag_barra:                      ['bicep_shorthead','bicep_brachialis'],
  curl_concentrado_polea:               ['bicep_shorthead'],
  curl_cruzado_banco_inclinado:         ['bicep_brachialis','bicep_longhead'],
  curl_kettlebell:                      ['bicep_longhead','bicep_shorthead'],
  ...
  extension_triceps_polea_cuerda:    ['tricep_pushdown'],
  extension_triceps_polea_un_brazo:  ['tricep_pushdown'],
  extension_triceps_polea_invertida: ['tricep_pushdown','tricep_longhead'],
  press_frances_ez:                  ['tricep_longhead'],
  press_frances_polea:               ['tricep_longhead'],
  extension_triceps_overhead_polea:    ['tricep_longhead'],
  extension_triceps_overhead_barra_ez: ['tricep_longhead'],
  press_cerrado_mancuernas:          ['tricep_compound','chest_mid'],
  patada_triceps_polea:              ['tricep_pushdown'],
  extension_triceps_jm_press:        ['tricep_compound','tricep_longhead'],
  extension_triceps_banco_unilateral:['tricep_longhead'],
  fondos_banco_triceps_lastrado:      ['tricep_compound','chest_lower'],
  flexiones_triceps_manos_estrechas:  ['tricep_compound','chest_mid'],
  extension_triceps_maquina:          ['tricep_pushdown'],
  triceps_press_banca_multipower:     ['tricep_compound','chest_mid'],
